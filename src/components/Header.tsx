...
const navItems = [
    ...
    { label: "Cara Kerja", href: "/dokumentasi#cara-kerja" },
];
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 border-b border-border bg-background/90 backdrop-blur-sm">
            <div className="container flex h-16 items-center justify-between">
                <Link
                    to="/"
                    className="flex items-center gap-2.5 font-heading text-lg font-bold tracking-tight text-primary"
                >
                    <img
                        src="/kriptosecure_logo.png"
                        alt="KriptoSecure"
